...
local jewList = {
    ...
    },
    {
        ...
        receiver = nil,
        issell = 0,
        list = { { '血石', '茶晶石', '太阳水晶', '黑玉', '玉髓石', '暗影水晶', '土之结晶', '萨隆邪铁矿石' }, { '血玉石', '帝黄晶', '秋色石', '森林翡翠', '天蓝石', '曙光猫眼石', '永恒之土' } }
    },
    {
        category = '垃圾',
        receiver = nil,
        issell = 0,
        list = { { '裂纹森林翡翠', '充能暗影水晶', '坚硬黑玉', '完美充能暗影水晶', '完美坚硬黑玉' }, { '水晶玉髓石项圈', '烈日石戒', '血石指环', '水晶茶晶石项链' } }
    },
    -- {
    --     category = '白龙',
    --     receiver = '小灬白龙',
    ...
    -- },
    {
        ...
        receiver = '咖喱贼',
        issell = 0,
        list = { { '血石', '茶晶石', '太阳水晶', '黑玉', '玉髓石', '暗影水晶', '永恒之土', '土之结晶' }, { '血玉石', '帝黄晶', '秋色石', '森林翡翠', '天蓝石', '曙光猫眼石', '萨隆邪铁矿石' } }
    },
    {
        category = '暗肌',
        receiver = '暗影肌',
